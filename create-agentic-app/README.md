...
Create a new app directly from NPM:
...
```bash
git clone https://github.com/Skabir2023/agentic-coding-starter-kit.git
cd agentic-coding-starter-kit
node create-agentic-app/index.js ../my-app
cd ../my-app
```
...
- Check the repository issues: [github.com/Skabir2023/agentic-coding-starter-kit/issues](https://github.com/Skabir2023/agentic-coding-starter-kit/issues)
